...
describe.only("CommandLine", () => {
	...
	describe("Nullability", () => {
		...
		it("allows arguments to be configured", () => {
			 ...
			 * Hints:
			 *
			 * 1. To take an optional parameter that defaults to an empty array in CommandLine.createNull(), use object
			 ...
			 * object has a field named args, which defaults to an empty array.")
			 *
			 ...
			 *    }
			 *
			 * The dots on the final parameter are called the "spread operator", and they insert the contents of
			 * this._args into the array.
			 *
			 */
